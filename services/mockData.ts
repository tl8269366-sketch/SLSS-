...
export const MOCK_ASSETS: Asset[] = [
  {
    ...
    model: '551C FKF',
    machine_sn: 'HM217S007647', // Real SN from prompt
    mb_model: 'X11DPI-N',
    mb_sn: '223B20146',
    cpu_model: '5115',
  ...
  },
  {
    ...
    model: '5406 FAF',
    machine_sn: 'WARN-2023-REPEAT', // Machine with recurring failure
    mb_model: 'X11DPI-N',
    mb_sn: 'OLD-MB-001',
...
export const MOCK_LIFECYCLE: LifecycleEvent[] = [
  ...
  },
  {
    ...
    details: '收到客户寄修机器，外观完好'
  },
  // Data for Charts (Simulated Repair Swaps)
  ...
  // Recurring Failure Simulation for WARN-2023-REPEAT
  // First swap
  { 
    id: 20, 
    machine_sn: 'WARN-2023-REPEAT', 
    event_type: 'REPAIR_SWAP', 
    part_name: '主板 (Motherboard)', 
    old_sn: 'OLD-MB-001', 
    new_sn: 'NEW-MB-001', 
    timestamp: '2023-06-01T10:00:00Z', 
    details: '第一次更换主板' 
  },
  // Second swap (This should trigger warning)
  { 
    id: 21, 
    machine_sn: 'WARN-2023-REPEAT', 
    event_type: 'REPAIR_SWAP', 
...
export const MOCK_TEST_REPORTS: TestReport[] = [
  {
    ...
    log_snippet: `
[11:00:01] Starting Stress Prime 2004 (Ortho)...
